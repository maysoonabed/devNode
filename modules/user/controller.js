...
export const find = async (req, res) => {
  const result = await service.userWithAge();
...
export const findUsersWithNoLikes = async (req, res) => {
  const result = await service.usersNoLikes();
  return res.send(result);
};
export const getAgeGroups = async (req, res) => {
  const result = await service.ageGroups();
  return res.send(result);
};
